...
<body>
	<form method="POST"  action="/study/mentor/mentorList.mentor" id="pfrm" name="pfrm">
	...
	<div class="w3-content mxw700 w3-margin-top w3-padding">
		...
		<!-- form 태그 -->
		<form method="POST" action="/study/mentor/mentorWriteProc.mentor" name="frm" id="frm"
			...
			<div class="w3-col w3-margin-top pdb10 w3-border-bottom w3-border-light-grey">
				<div class="w3-rest pdr30">
					<input type="text" name="subject" id="subject" class="w3-rest w3-input w3-round w3-border" placeholder="과목을 입력하세요!">
				</div>
			</div>
			<div class="w3-col w3-margin-top pdb10 w3-border-bottom w3-border-light-grey">
				<div class="w3-rest pdr30">
			...
			<div class="w3-col w3-margin-top w3-margin-bottom pdb10 w3-border-bottom w3-border-light-grey">
				<div class="w3-rest pdr30">
					<textarea name="pr" id="pr" rows="7" 
							class="w3-rest w3-input w3-round w3-border vresize" placeholder="자기소개를 해주세요!"></textarea>
				</div>
			</div>
		</form>
		...
		<div class="w3-col w3-margin-top w3-card-4">
			...
			<div class="w3-third w3-orange w3-hover-red w3-button" id="sbtn">등록완료</div>
		</div>
	</div>
</body>
</html>