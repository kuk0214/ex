...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#ebtn').click(function() {
			$('#pfrm').attr('action', '/study/reviewboard/reviewBoardEdit.mentor');
			$('#pfrm').submit();
		});
		
		$('#dbtn').click(function() {
			$('#pfrm').attr('action', '/study/reviewboard/reviewBoardDel.mentor');
			$('#pfrm').submit();
		});
	});
</script>
...
<body>
	...
	<c:if test="${SID eq DATA.wid}">
			<div class="w3-thrid m3 w3-button w3-right w3-blue" id="ebtn">수정하기</div>
			<div class="w3-thrid m3 w3-button w3-right w3-red" id="dbtn">삭제하기</div>
	</c:if>
		</div>
	</div>
</body>
