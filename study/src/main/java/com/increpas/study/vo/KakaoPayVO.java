...
public class KakaoPayVO {
	...
	private MDataVO amount;
	private CDataVO card_info;
	...
	public MDataVO getAmount() {
		return amount;
	}
	public void setAmount(MDataVO amount) {
		this.amount = amount;
	}
	public CDataVO getCard_info() {
		return card_info;
	}
	public void setCard_info(CDataVO card_info) {
	...
	public String toString() {
		return "KakaoPayVO [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", sid=" + sid + ", partner_order_id="
